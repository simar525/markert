...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/reviewer/css/app.css') }}" />
    @if (getDirection() == 'rtl')
        <link rel="stylesheet" href="{{ asset('vendor/reviewer/css/app.rtl.css') }}">
    @endif
    @reviewerCustomStyle
</head>
...
<body class="sign-body">
    ...
    <script src="{{ asset('vendor/reviewer/js/app.js') }}"></script>
    @toastrRender
    @if ($errors->any())
        <script>
