        ...
        @push('top_scripts')
            <script>
                ...
                const itemConfig = {!! json_encode([
                    ...
                    'buyer_fee' => [
                        'regular' => intval($item->category->regular_buyer_fee),
                        'extended' => intval($item->category->extended_buyer_fee),
                    ],
                    'prices' => [
                        'regular' => intval($item->regular_price),
                        'extended' => intval($item->extended_price),
                    ],
                ]) !!};
            </script>
        @endpush
        @push('scripts_libs')
            <script src="{{ asset('themes/basic/assets/js/item.js') }}"></script>
        @endpush
    @endif
@endsection
